...
files = {
    "lib/api.ts": """const BASE = process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000";
...
export const metadata: Metadata = { title: "Tasks App" };
...
""",
    ...
    "app/components/TaskForm.tsx": """"use client";
...
""",
    ...
    "app/components/TaskCard.tsx": """"use client";
...
print("\n🎉 All frontend files created! Run: cd frontend && npm run dev")